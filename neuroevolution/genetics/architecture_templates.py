...
_TEMPLATES: Dict[str, ArchitectureTemplate] = {
    "lenet_conv1d_tiny": ArchitectureTemplate(
        template_id="lenet_conv1d_tiny",
        template_family="lenet",
    ...
    "alexnet_conv1d_small": ArchitectureTemplate(
        template_id="alexnet_conv1d_small",
        template_family="alexnet",
        conv_topology="sequential",
        num_conv_layers=3,
        filters=(8, 12, 16),
        kernel_sizes=(7, 5, 3),
    ...
    "vgg_conv1d_small": ArchitectureTemplate(
        template_id="vgg_conv1d_small",
        template_family="vgg",
        conv_topology="sequential",
        num_conv_layers=4,
        filters=(8, 8, 16, 16),
    ...
    "resnet_conv1d_medium": ArchitectureTemplate(
        template_id="resnet_conv1d_medium",
        template_family="resnet",
        conv_topology="residual",
        num_conv_layers=6,
        filters=(8, 8, 12, 12, 16, 16),
    ...
    "wide_resnet_conv1d_small": ArchitectureTemplate(
        template_id="wide_resnet_conv1d_small",
        template_family="wide_resnet",
        conv_topology="residual",
        num_conv_layers=4,
        filters=(12, 12, 16, 16),
        kernel_sizes=(3, 3, 3, 3),
    ...
    "googlenet_inception_conv1d_medium": ArchitectureTemplate(
        template_id="googlenet_inception_conv1d_medium",
        template_family="googlenet",
        conv_topology="inception",
        num_conv_layers=4,
        filters=(8, 12, 16, 16),
        kernel_sizes=(5, 7, 7, 7),
        num_fc_layers=2,
        fc_nodes=(16, 8),
        inception_reduction_ratio=0.5,
        inception_pool_branch=True,
    ),
    "inception_conv1d_wide": ArchitectureTemplate(
        template_id="inception_conv1d_wide",
        template_family="inception",
        conv_topology="inception",
        num_conv_layers=3,
        filters=(12, 16, 16),
        kernel_sizes=(5, 7, 9),
