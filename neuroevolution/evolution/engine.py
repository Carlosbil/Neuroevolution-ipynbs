...
class HybridNeuroevolution:
    ...
    def save_best_checkpoint(self, genome: dict, model: nn.Module):
        ...
        checkpoint_data = {
            ...
            'training_data_source': self.config.get('data_source', 'synthetic'),
            'selection_data_source': self.config.get('data_source', 'synthetic'),
            'internal_test_data_source': self.config.get('data_source', 'synthetic'),
            'final_evaluation_data_source': self.config.get('final_evaluation_data_source', 'real'),
