...
def get_default_config(info_path: str = None) -> dict:
    ...
    if info_path is None:
        info_path = os.path.join("artifacts", "neo_conc_audio")
    ...
    return {
        ...
        # neo_conc — concurrent individuals per generation on a single fold
        'concurrent_individuals': 5,
        'fold_rotation_strategy': 'sequential',  # 'sequential' or 'random'
        'fold_rotation_offset': 1,
