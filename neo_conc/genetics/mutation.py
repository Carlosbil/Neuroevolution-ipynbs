...
import uuid
import numpy as np
from neo_conc.config import ACTIVATION_FUNCTIONS, OPTIMIZERS
from neo_conc.models.genome_validator import is_genome_valid, validate_and_fix_genome
from neo_conc.genetics.innovation import build_innovation_genes, append_structural_event
