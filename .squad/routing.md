...
|-----------|----------|----------|
| Neuroevolution architecture and search-space strategy | Ripley | Genome design, mutation policy, generation strategy |
| Core algorithm and evolution loop implementation | Bishop | Refactor/implement evolution operators and selection flow |
| Training throughput and fold orchestration | Hicks | Parallel evaluation, fold rotation, execution performance |
| Code review | Vasquez | Review PRs, check quality, suggest improvements |
