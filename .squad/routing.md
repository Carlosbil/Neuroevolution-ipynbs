...
|-----------|----------|----------|
| Architecture decisions | Ripley | Module breakdown, refactoring strategies, design |
| Python scripts & implementation | Dallas | Extract logic to scripts, create modules, implement |
| Validation & testing | Hockley | Verify functionality, compare results, test edge cases |
| Code review | Ripley | Review PRs, check quality, suggest improvements |
| Testing | Hockley | Write tests, find edge cases, verify fixes |
